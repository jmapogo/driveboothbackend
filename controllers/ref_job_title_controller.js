module.exports = function (app, model, sequelize, Sequelize, ssCRUD, moment, mysql, underscore) {
	...
	var queryHelper;
	var primary_key = "";
	var all_columns = underscore.map(ref_job_title.rawAttributes, function (item) {
	...
	query += " AND t.table_name='ref_job_title' ";
